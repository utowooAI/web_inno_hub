(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.HistoryLibrary = {}, global.queryString));
  ...
  function createPath(_ref) {
    ...
    if (search && search !== "?") pathname += search.charAt(0) === "?" ? search : "?" + search;else if (query) {
      var queryString$1 = queryString.stringify(query);
      if (queryString$1) pathname += "?" + queryString$1;
    }
  ...
  function parsePath(path) {
    ...
    if (path) {
      ...
      if (searchIndex >= 0) {
        ...
        parsedPath.query = parsedPath.query || queryString.parse(parsedPath.search || '') || {};
